...
activities = {
    ...
    "Soccer Club": {
        ...
        "max_participants": 22,
        "participants": ["aaron@mergington.edu", "sara@mergington.edu"]
    },
    "Art Club": {
    ...
    "Debate Team": {
        "description": "Develop public speaking, argumentation skills and compete in debates",
        "schedule": "Mondays, 4:00 PM - 5:30 PM",
        "max_participants": 16,
        "participants": ["alex@mergington.edu", "mia@mergington.edu"]
    },
    "Science Club": {
        "description": "Hands-on experiments, science projects and Olympiad prep",
